...
public class Main{
    public static void main(String[] args) throws MyExeption {
        ...
        String argument1, argument2, finalResultRome, checkCorrectSymbol = new String();
        char operator;
    ...
    //Проверка корректности введенных данных.
        ...
        //Общая длина примера
        String arithmeticPrimer = scanner.nextLine();
        lengthPrimer = arithmeticPrimer.length();
        if (lengthPrimer > 11) {  //По условиям получатеся максимальная длина примера не более 11 символов, включая внутренние пробелы.
            ...
            System.exit(0);   //не забыть убрать. Ловить Exeption
        }
        ...
        // Разложим строку на символы. Создадим массив символов
                    // System.out.println("Длина выражения - " + lengthPrimer);
        ...
        boolean bothRomeCorrect = romeArgument1 & romeArgument2;
        ...
        //System.out.println(argument1);
        //System.out.println(arabicArgument1);
        //System.out.println(argument2);
        //System.out.println(arabicArgument2);
        //System.out.println("обе арабские " +bothArabicCorrect);



        //System.out.println("римские");
        //System.out.println(argument1);
        //System.out.println(romeArgument1);
        //System.out.println(argument2);
        //System.out.println(romeArgument2);
        //System.out.println("обе не арабские "+bothRomeCorrect);
        ...
        // System.out.println(corectOperator);
        ...
        //Служебные данные для проверки
        //System.out.println(finalArgument1);
        //System.out.println(operator);
        //System.out.println(finalArgument2);
        ...
        if (arabic) {
            System.out.println("результат " + finalResultArabic);
        }
        else {
            if (finalResultArabic < 1){
                ...
                finalResultRome = romeAnswer[finalResultArabic];

                System.out.println(finalResultRome);
            }
        }
    }
}